...
/**
 * Default implementation for {@link ShapeToJavaType}.
 */
public final class DefaultShapeToJavaType extends ShapeVisitor.Default<TypeName> implements ShapeToJavaType {
    private final ShapeToJavaName shapeToJavaName;
    private final Model model;

    public DefaultShapeToJavaType(ShapeToJavaName shapeToJavaName, Model model) {
