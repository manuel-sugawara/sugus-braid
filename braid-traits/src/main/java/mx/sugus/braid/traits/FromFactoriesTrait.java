...
public final class FromFactoriesTrait extends AbstractTrait implements ToSmithyBuilder<FromFactoriesTrait> {
    public static final ShapeId ID = ShapeId.from("mx.sugus.braid.traits#fromFactories");
    private final List<BuilderOverride> values;

    private FromFactoriesTrait(Builder builder) {
     ...
     */
    @Override
    public SmithyBuilder<FromFactoriesTrait> toBuilder() {
     ...
     */
    public static final class Builder extends AbstractTraitBuilder<FromFactoriesTrait, Builder> {
        ...
        @Override
        public FromFactoriesTrait build() {
            return new FromFactoriesTrait(this);
        }
    }
    ...
    public static final class Provider extends AbstractTrait.Provider {
        ...
        public Trait createTrait(ShapeId target, Node value) {
            FromFactoriesTrait result = fromNode(value);
