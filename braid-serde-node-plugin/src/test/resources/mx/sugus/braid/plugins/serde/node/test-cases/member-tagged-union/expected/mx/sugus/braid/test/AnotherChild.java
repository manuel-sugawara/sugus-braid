...
public final class AnotherChild implements SyntaxNode, ToNode {
    private final String stringValue;
    private final Integer intValue;

    private AnotherChild(Builder builder) {
    ...
    public static final class Builder implements SyntaxNode.Builder {
        ...
        /**
         * Returns a new instance of {@link AnotherChild}
         * 
         * @return A new instance of {@link AnotherChild}
         */
        public AnotherChild build() {
            return new AnotherChild(this);
        }
    }
}
